...
FUSION_METHOD1 = 'max'
# Read the two image
I0 = cv2.imread("D:\\Desktop\\test\\dof\\test4.jpg", 0)
I2 = cv2.imread("D:\\Desktop\\test\\dof\\test2.jpg", 0)
I1 = cv2.resize(I0, (4508, 4096))
...
# Fith: Show image
cv2.imwrite("D:\\Desktop\\test\\dof\\win.bmp", fusedImage1)
